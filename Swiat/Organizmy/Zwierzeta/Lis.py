    ...
    def akcja(self, all_positions: list[list[int]], *args):
        if not self.omit_akcja:
            ...
            if len(available_positions) > 0:
                ...
                self.swiat.game.narratorLog(f"{self.__class__.__name__} na polu {self.position} przeszedł na pole {available_positions[choose_position]}, unikając ewentualnego zagrożenia")
